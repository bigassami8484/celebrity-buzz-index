...
import { Search, Crown, Film, Tv, Music, Trophy, Star, Share2, X, Copy, Check, TrendingUp, TrendingDown, Minus, Plus, Users, Info, ChevronUp, Newspaper, ArrowLeftRight, Skull, Facebook, UserPlus, Home, Clock, Bell, LineChart, Mail, LogOut } from "lucide-react";
...
const Header = () => (
  <header className="py-2 md:py-8 px-1 text-center">
    <h1 className="font-anton text-[3.5rem] sm:text-[4.5rem] md:text-[6rem] lg:text-[7rem] xl:text-[8rem] tracking-tighter uppercase header-title leading-[0.85]" data-testid="main-title">
    ...
    <h1 className="font-anton text-[3.5rem] sm:text-[4.5rem] md:text-[6rem] lg:text-[7rem] xl:text-[8rem] tracking-tighter uppercase header-title leading-[0.85]" data-testid="main-title-2">
    ...
    <div className="App">
      ...
      <div className="max-w-7xl mx-auto px-4 py-8">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 mt-8">
          ...
          {/* Sidebar - Only Price Alerts, Hot Streaks, and Hall of Fame on desktop */}
          <div className="lg:col-span-4 space-y-6">
            <PriceAlerts alerts={priceAlerts} teamId={team?.id} />
            <HotStreaks streaks={hotStreaks} teamId={team?.id} />
            
            {/* Show these only on mobile - they're in center section on desktop */}
      ...
      {/* Mobile Team Floating Button - Only visible on mobile */}
      <button
