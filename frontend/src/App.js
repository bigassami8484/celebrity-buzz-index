...
// Hot Celebs This Week Banner Component - At Top
const HotCelebsBanner = ({ celebs, onSelect }) => {
  if (!celebs || celebs.length === 0) return null;
  
  return (
    <div className="bg-gradient-to-r from-[#FF0099]/30 via-[#0A0A0A] to-[#00F0FF]/30 border-b border-[#FF0099]/50 p-4" data-testid="hot-celebs-banner">
