...
const Header = () => (
  <header className="py-2 md:py-8 px-1 text-center">
    <h1 className="font-anton text-[3.5rem] sm:text-[5rem] md:text-[8rem] lg:text-[12rem] xl:text-[14rem] tracking-tighter uppercase header-title leading-[0.85]" data-testid="main-title">
    ...
    <h1 className="font-anton text-[3.5rem] sm:text-[5rem] md:text-[8rem] lg:text-[12rem] xl:text-[14rem] tracking-tighter uppercase header-title leading-[0.85]" data-testid="main-title-2">
